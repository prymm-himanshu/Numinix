          ...
          contents: [
            {
              parts: [
                {
                  text: `Create a personalized study plan for this student based on their diagnostic results.
          ...
          contents: [
            {
              parts: [
                {
                  text: `You are a friendly math mentor explaining ${topic} to a ${studentLevel} student. 
          ...
          contents: [
            {
              parts: [
                {
                  text: `Generate a motivational, personalized notification for a student based on their progress.
